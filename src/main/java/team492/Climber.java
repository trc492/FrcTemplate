...
public class Climber
{
    ...
    public Climber(Robot robot)
    {
        ...
        climberTaskObj = TrcTaskMgr.createTask("Climber.climberTask", this::climberTask);

        latch = new FrcPneumatic("Climber.latch", RobotInfo.CANID_PCM, PneumaticsModuleType.CTREPCM, RobotInfo.SOL_LATCH_EXTEND,
    ...
    private void climberTask(TrcTaskMgr.TaskType taskType, RunMode runMode)
    {
