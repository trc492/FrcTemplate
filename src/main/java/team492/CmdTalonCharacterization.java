...
import TrcFrcLib.frclib.FrcCANPhoenixController;
 ...
 */
public class CmdTalonCharacterization implements RobotCommand
{
    ...
    public boolean cmdPeriodic(double elapsedTime)
    {
        ...
        FrcDashboard.getInstance().displayPrintf(3, "time%.3f,batt=%.1f,speed=%.2f,volts=%.2f,pos=%.2f,rate=%.3f",
            (Object[]) numberArray);
