...
public class Shooter
{
    ...
    public Shooter(Robot robot)
    {
        ...
        pitchControlTaskObj = TrcTaskMgr.createTask("PitchControlTask", this::pitchControlTask);
    ...
    private void offsetPitchPos()
    {
        ...
        robot.globalTracer.traceInfo("Shooter.offsetPitchPos",
    ...
    private void pitchControlTask(TrcTaskMgr.TaskType taskType, RunMode runMode)
    {
        if (pitchTicksTarget != null)
        {
            pitchMotor.motor.set(USE_MM ? TalonSRXControlMode.MotionMagic : TalonSRXControlMode.Position, pitchTicksTarget,
