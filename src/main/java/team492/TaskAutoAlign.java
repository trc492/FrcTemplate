...
public class TaskAutoAlign
{
    ...
    {
        this.robot = robot;
        taskObject = TrcTaskMgr.createTask(instanceName + ".task", this::alignTask);
    ...
    private void alignTask(TrcTaskMgr.TaskType taskType, RunMode runMode)
    {
        ...
        {
            robot.autoShooter.shoot(null, 3, 5.0, TaskAutoShooter.Mode.SHOOT_ONLY, event, true);
        }
    }
}
