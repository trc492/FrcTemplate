...
import TrcCommonLib.trclib.TrcWarpSpace;
...
public class TaskSnapToAngle
{
    ...
    public TaskSnapToAngle(Robot robot)
    {
        ...
        taskObj = TrcTaskMgr.createTask(instanceName + ".TaskObj", this::controlTask);
    }

    private void controlTask(TrcTaskMgr.TaskType taskType, RunMode runMode)
    {
