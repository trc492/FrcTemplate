...
public class SwerveModule {
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop){
        if(isOpenLoop){
            ...
            SmartDashboard.putNumber("Set Speed", percentOutput);
        }
        else {
    ...
    public void resetToAbsolute(){
        double absolutePosition = Conversions.degreesToFalcon(getAngleEncoderPos().getDegrees() - angleOffset.getDegrees(), Constants.Swerve.angleGearRatio);
        mAngleMotor.setSelectedSensorPosition(absolutePosition);
    }

    private void configAngleEncoder(){
        angleEncoder.resetFactoryDefaults(Constants.Swerve.resetEncoder);
